...
# CLAUDE.md — Small Business KPI Copilot

Conventions for this build. Claude Code reads this automatically.

## What this is

An application that automates data processing from Excel/CSV uploads to generate actionable business insights and alerts for small business owners.
...
https://github.com/Pamy77/colaberry-architect-workspace
